...
$UPCXX_INSTALL/bin/upcxx-run -n 1  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=20000  --percentage=10 --model=knodel --metrics-json-path=nodes-1-model-knodel-vertexNumber-20000-percentage-10-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 2  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=20000  --percentage=10 --model=knodel --metrics-json-path=nodes-2-model-knodel-vertexNumber-20000-percentage-10-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 4  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=20000  --percentage=10 --model=knodel --metrics-json-path=nodes-4-model-knodel-vertexNumber-20000-percentage-10-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 8  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=20000  --percentage=10 --model=knodel --metrics-json-path=nodes-8-model-knodel-vertexNumber-20000-percentage-10-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 16  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=20000 --percentage=10 --model=knodel --metrics-json-path=nodes-16-model-knodel-vertexNumber-20000-percentage-10-algorithm-randomizedpushgossip.json &&

$UPCXX_INSTALL/bin/upcxx-run -n 1  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=30000  --percentage=15 --model=knodel --metrics-json-path=nodes-1-model-knodel-vertexNumber-30000-percentage-15-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 2  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=30000  --percentage=15 --model=knodel --metrics-json-path=nodes-2-model-knodel-vertexNumber-30000-percentage-15-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 4  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=30000  --percentage=15 --model=knodel --metrics-json-path=nodes-4-model-knodel-vertexNumber-30000-percentage-15-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 8  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=30000  --percentage=15 --model=knodel --metrics-json-path=nodes-8-model-knodel-vertexNumber-30000-percentage-15-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 16  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=30000 --percentage=15 --model=knodel --metrics-json-path=nodes-16-model-knodel-vertexNumber-30000-percentage-15-algorithm-randomizedpushgossip.json &&

$UPCXX_INSTALL/bin/upcxx-run -n 1  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=40000  --percentage=20 --model=knodel --metrics-json-path=nodes-1-model-knodel-vertexNumber-40000-percentage-20-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 2  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=40000  --percentage=20 --model=knodel --metrics-json-path=nodes-2-model-knodel-vertexNumber-40000-percentage-20-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 4  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=40000  --percentage=20 --model=knodel --metrics-json-path=nodes-4-model-knodel-vertexNumber-40000-percentage-20-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 8  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=40000  --percentage=20 --model=knodel --metrics-json-path=nodes-8-model-knodel-vertexNumber-40000-percentage-20-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 16  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=40000 --percentage=20 --model=knodel --metrics-json-path=nodes-16-model-knodel-vertexNumber-40000-percentage-20-algorithm-randomizedpushgossip.json &&

$UPCXX_INSTALL/bin/upcxx-run -n 1  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=50000  --percentage=25 --model=knodel --metrics-json-path=nodes-1-model-knodel-vertexNumber-50000-percentage-25-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 2  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=50000  --percentage=25 --model=knodel --metrics-json-path=nodes-2-model-knodel-vertexNumber-50000-percentage-25-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 4  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=50000  --percentage=25 --model=knodel --metrics-json-path=nodes-4-model-knodel-vertexNumber-50000-percentage-25-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 8  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=50000  --percentage=25 --model=knodel --metrics-json-path=nodes-8-model-knodel-vertexNumber-50000-percentage-25-algorithm-randomizedpushgossip.json &&
$UPCXX_INSTALL/bin/upcxx-run -n 16  -shared-heap 1G ${PGAS_BINARY_PATH} --vertex-count=50000 --percentage=25 --model=knodel --metrics-json-path=nodes-16-model-knodel-vertexNumber-50000-percentage-25-algorithm-randomizedpushgossip.json
