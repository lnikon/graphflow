...
$UPCXX_INSTALL/bin/upcxx-run -n 1 -shared-heap 1G ./../build/pgas-graph-new-storage --vertex-count=10000 --percentage=85 &&
$UPCXX_INSTALL/bin/upcxx-run -n 2 -shared-heap 1G ./../build/pgas-graph-new-storage --vertex-count=10000 --percentage=85 &&
$UPCXX_INSTALL/bin/upcxx-run -n 1 -shared-heap 1G ./../build/pgas-graph-new-storage --vertex-count=10000 --percentage=90 &&
$UPCXX_INSTALL/bin/upcxx-run -n 2 -shared-heap 1G ./../build/pgas-graph-new-storage --vertex-count=10000 --percentage=90
